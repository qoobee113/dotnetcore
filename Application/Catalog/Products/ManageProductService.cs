...
namespace Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new AppExeptions($"Cannot find a product : {productId}");
        ...
        public async Task<PagedResult<ProductViewModel>> GetAllPaging(GetManageProductPagingRequest request, string languageId)
        {
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new AppExeptions($"Cannot find an image with id {imageId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslation == null) throw new AppExeptions($"Cannot find a product : {request.Id}");
